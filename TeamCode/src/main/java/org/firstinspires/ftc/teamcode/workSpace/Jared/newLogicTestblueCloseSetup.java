package org.firstinspires.ftc.teamcode.workSpace.Jared;
...
@Autonomous(name = "newLogicTestblueCloseSetup", group = "Test")
public class newLogicTestblueCloseSetup extends LinearOpMode {
    ...
    private void telemetryTfod() {
        ...
        for (Recognition recognition : currentRecognitions) {
            ...
            if (x<=330 && timer.milliseconds() < 1000){
                timer.reset();
                Left = true;
                Middle = false;
                telemetry.addLine("Left");
            } else if ( 330 <= x && timer.milliseconds() < 1000) {
                timer.reset();
                Left = false;
                Middle = true;
